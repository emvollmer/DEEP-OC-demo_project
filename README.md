...
```bash
$ docker run -ti -p 5000:5000 -p 6006:6006 -p 8888:8888 deephdc/uc-emvollmer-deep-oc-demo_project
```
...
```bash
git clone https://github.com/emvollmer/DEEP-OC-demo_project
cd DEEP-OC-demo_project
docker build -t deephdc/uc-emvollmer-deep-oc-demo_project .
docker run -ti -p 5000:5000 -p 6006:6006 -p 8888:8888 deephdc/uc-emvollmer-deep-oc-demo_project
```
